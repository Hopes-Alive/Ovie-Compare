...
const PRODUCT_SELECT =
  "id, name, external_id, external_sku, supplier_product_url, price, stock_status, stock_quantity, brand, category, subcategory, description, image_src, pack_size, unit_of_measure, currency, price_includes_gst, delivery_text, delivery_min_days, delivery_max_days, supplier_id, suppliers!inner(id, slug, name, adapter_key, live_check_enabled, is_active)";
